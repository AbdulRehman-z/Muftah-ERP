...
export const createRecipeSchema = z.object({
    ...
    batchSize: z.string()
        ...
        .refine((val) => !isNaN(parseFloat(val)) && parseFloat(val) > 0, "Batch size must be a positive number"),
...
export type AdditionalPackagingItem = z.infer<typeof additionalPackagingItemSchema>;
