...
export const verificationEmailTemplate = ({ user, url }: Input) => {
	return `
                  ...
                  <tr>
                    <td>
                      ...
                      <p
                        ...
                        We need to verify your email address to complete your
                        account setup
                      </p>
                    </td>
                  </tr>
                ...
                <tbody>
                  <tr>
                    <td>
                      ...
                      <p
                        style="font-size:16px;color:rgb(31,41,55);line-height:24px;margin:0px;margin-bottom:16px;margin-top:0px;margin-left:0px;margin-right:0px">
                        Thank you for signing up! To get started, please verify
