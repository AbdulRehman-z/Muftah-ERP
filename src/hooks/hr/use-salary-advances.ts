import { createSalaryAdvanceFn, approveSalaryAdvanceFn, rejectSalaryAdvanceFn, listSalaryAdvancesFn } from "@/server-functions/hr/advances/advances-fn";
...
export const useCreateSalaryAdvance = () => {
    ...
    return useMutation({
        ...
        onError: (err: any) => toast.error(err.message || "Failed to create advance"),
    });
};
...
export const useApproveSalaryAdvance = () => {
    ...
    return useMutation({
        ...
        onError: (err: any) => toast.error(err.message || "Failed to approve advance"),
    });
};
...
export const useRejectSalaryAdvance = () => {
    ...
    return useMutation({
        ...
        onError: (err: any) => toast.error(err.message || "Failed to reject advance"),
    });
};
