...
import { db, materialStock, packagingMaterials, warehouses, purchaseRecords, supplierPayments } from "@/db";
    ...
    .handler(async ({ data }) => {
        return await db.transaction(async (tx) => {
            ...
            if (warehouse.type !== "factory_floor") {
                throw new Error("Packaging materials must be added to a Factory Floor facility.");
            }
