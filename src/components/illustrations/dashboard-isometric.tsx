...
// const CalibrationMarks = ({ color }: { color: string }) => (
//     <g stroke={color} strokeWidth="0.5" opacity="0.4" className="pointer-events-none">
//         <path d="M 5 5 L 10 5 M 5 5 L 5 10" />
//         <path d="M 95 5 L 90 5 M 95 5 L 95 10" />
//         <path d="M 5 95 L 10 95 M 5 95 L 5 90" />
//         <path d="M 95 95 L 90 95 M 95 95 L 95 90" />
//         <circle cx="50" cy="50" r="45" strokeDasharray="2 4" opacity="0.2" />
//         <text x="5" y="15" fill={color} fontSize="4" fontFamily="monospace" opacity="0.6">SYS.OPT</text>
//         <text x="75" y="95" fill={color} fontSize="4" fontFamily="monospace" opacity="0.6">v2.4.0</text>
//     </g>
// );

// // ── 1. Schematic Vat (Gross Revenue) ───────────────────────────────────────
// export function SchematicVat({ theme }: { theme: string }) {
//     const color = theme === "emerald" ? "#10b981" : "#3b82f6";
//     return (
//         <svg viewBox="0 0 100 100" className="w-full h-full stroke-muted-foreground/30 fill-none" strokeWidth="0.75" vectorEffect="non-scaling-stroke">
//             <CalibrationMarks color={color} />

//             {/* Structural Wireframe */}
//             <ellipse cx="50" cy="25" rx="30" ry="8" />
//             <ellipse cx="50" cy="20" rx="30" ry="8" strokeDasharray="1 2" />
//             <path d="M 20 25 L 20 70 A 30 8 0 0 0 80 70 L 80 25" />
//             <line x1="50" y1="5" x2="50" y2="85" strokeDasharray="2 2" />
//             <rect x="45" y="0" width="10" height="12" />

//             {/* Input / Output Pipes */}
//             <path d="M 5 35 L 20 35 M 5 65 L 20 65" />

//             {/* Rotating Internal Agitator */}
//             <motion.g animate={{ rotateY: [0, 360] }} transition={{ duration: 3, repeat: Infinity, ease: "linear" }} style={{ transformOrigin: "50px 45px" }}>
//                 <path d="M 50 25 L 50 65 M 35 60 L 65 60 M 40 45 L 60 45" stroke={color} opacity="0.5" />
//             </motion.g>

//             {/* Live Data Flow Level */}
//             <motion.path
//                 d="M 20 65 Q 35 60 50 65 T 80 65 L 80 70 A 30 8 0 0 1 20 70 Z"
//                 fill={color} stroke="none" opacity="0.15"
//                 animate={{
//                     d: [
//                         "M 20 65 Q 35 55 50 65 T 80 65 L 80 70 A 30 8 0 0 1 20 70 Z",
//                         "M 20 65 Q 35 75 50 65 T 80 65 L 80 70 A 30 8 0 0 1 20 70 Z"
//                     ]
//                 }}
...
//             {/* Flow Particles */}
//             <motion.circle cx="50" cy="50" r="1.5" fill={color} stroke="none" animate={{ cy: [70, 30], opacity: [1, 0] }} transition={{ duration: 1.5, repeat: Infinity }} />
//             <motion.circle cx="10" cy="35" r="1" fill={color} stroke="none" animate={{ cx: [5, 20], opacity: [0, 1] }} transition={{ duration: 1, repeat: Infinity }} />
//         </svg>
//     );
// }

// // ── 2. Schematic Conveyor (Active Production) ──────────────────────────────
// export function SchematicConveyor({ theme }: { theme: string }) {
//     const color = theme === "blue" ? "#3b82f6" : "#10b981";
//     return (
//         <svg viewBox="0 0 100 100" className="w-full h-full stroke-muted-foreground/30 fill-none" strokeWidth="0.75">
//             <CalibrationMarks color={color} />
...
//             {/* Belt Rollers */}
//             {[25, 40, 55, 70].map(cx => <circle key={cx} cx={cx} cy="75" r="2" strokeDasharray="1 1" />)}

//             {/* Scanning Arch */}
//             <path d="M 45 20 L 45 55 L 55 60 L 55 20 Z" />
//             <line x1="40" y1="30" x2="60" y2="30" strokeDasharray="2 1" />

//             {/* Live Assembly Line (Bottles) */}
//             <motion.g animate={{ x: [0, 30] }} transition={{ duration: 1.5, repeat: Infinity, ease: "linear" }}>
//                 {[-1, 0, 1, 2, 3].map(i => (
//                     <g key={i} transform={`translate(${i * 30 - 15}, 0)`}>
//                         <path d="M 15 45 L 15 65 A 2 2 0 0 0 25 65 L 25 45 L 22 38 L 18 38 Z" />
//                         <rect x="19" y="35" width="2" height="3" />
//                         {/* Liquid Fill */}
//                         <motion.path d="M 15 55 L 15 65 A 2 2 0 0 0 25 65 L 25 55 Z" fill={color} stroke="none"
//                             animate={{ opacity: [0, 0.5, 0] }} transition={{ duration: 1.5, repeat: Infinity }}
//                         />
//                     </g>
//                 ))}
//             </motion.g>
...
//                 animate={{ x1: [45, 55, 45], x2: [45, 55, 45], opacity: [0.2, 1, 0.2] }}
...
// // ── 3. Schematic Burner (Operational Burn) ─────────────────────────────────
// export function SchematicBurner({ theme }: { theme: string }) {
//     const color = theme === "rose" ? "#f43f5e" : "#f59e0b";
//     return (
//         <svg viewBox="0 0 100 100" className="w-full h-full stroke-muted-foreground/30 fill-none" strokeWidth="0.75">
//             <CalibrationMarks color={color} />

//             {/* Structural Wireframe */}
//             <polygon points="25,85 75,85 85,35 15,35" />
//             <rect x="40" y="10" width="20" height="25" />
//             <line x1="15" y1="60" x2="85" y2="60" strokeDasharray="4 2" />

//             {/* Intake / Outtake */}
//             <path d="M 5 70 L 25 70 M 75 70 L 95 70" />
//             <rect x="45" y="85" width="10" height="10" />

//             {/* Thermal Combustion Map */}
//             <motion.path
//                 d="M 35 70 Q 50 40 65 70"
//                 stroke={color} strokeWidth="1.5" opacity="0.8"
//                 animate={{ d: ["M 35 70 Q 50 30 65 70", "M 35 70 Q 50 50 65 70"] }}
//                 transition={{ duration: 0.4, repeat: Infinity, ease: "easeInOut" }}
//             />
//             <motion.path
//                 d="M 40 75 Q 50 50 60 75"
//                 stroke={color} strokeWidth="1" opacity="0.4"
//                 animate={{ d: ["M 40 75 Q 50 55 60 75", "M 40 75 Q 50 45 60 75"] }}
//                 transition={{ duration: 0.3, repeat: Infinity, ease: "easeInOut", delay: 0.1 }}
//             />

//             {/* Embers / Data Particles */}
//             {[1, 2, 3].map(i => (
//                 <motion.circle key={i} cx="50" cy="70" r="1.5" fill={color} stroke="none"
//                     animate={{ cy: [70, 10], cx: [50, 40 + Math.random() * 20], opacity: [0.8, 0] }}
...
// // ── 4. Schematic Packer (Cartons Yield) ────────────────────────────────────
// export function SchematicPacker({ theme }: { theme: string }) {
//     const color = theme === "cyan" ? "#06b6d4" : "#10b981";
//     return (
//         <svg viewBox="0 0 100 100" className="w-full h-full stroke-muted-foreground/30 fill-none" strokeWidth="0.75">
//             <CalibrationMarks color={color} />
...
//             {/* Robotic Automation Arm (X/Y Gantry) */}
//             <motion.g animate={{ x: [0, 30, 0, 30], y: [0, 0, 30, 30] }} transition={{ duration: 4, repeat: Infinity, ease: "linear" }}>
//                 {/* Moving Box */}
//                 <rect x="25" y="25" width="20" height="20" stroke={color} strokeWidth="1" strokeDasharray="2 2" fill={`${color}20`} />
//                 {/* Gantry Crosshairs */}
//                 <circle cx="35" cy="35" r="3" fill={color} stroke="none" />
//                 <line x1="25" y1="35" x2="45" y2="35" stroke={color} />
//                 <line x1="35" y1="25" x2="35" y2="45" stroke={color} />
//             </motion.g>

//             {/* Target Nodes */}
//             <circle cx="35" cy="35" r="1" fill={color} />
//             <circle cx="65" cy="35" r="1" fill={color} />
//             <circle cx="35" cy="65" r="1" fill={color} />
//             <circle cx="65" cy="65" r="1" fill={color} />
//         </svg>
//     );
// }
import { motion } from "framer-motion";
