          ...
          {isBanned ? (
            <div className="flex flex-col gap-4 p-4 border border-emerald-500/10 bg-emerald-500/5 rounded-xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-sm text-emerald-900 leading-tight">
                    Restore Access
                  </p>
              ...
              <Button
                ...
                onClick={() =>
                  unbanUser.mutate({ userId: user.id }, { onSuccess })
                }
            ...
            <div className="flex flex-col gap-4 p-4 border border-orange-500/10 bg-orange-500/5 rounded-xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-sm text-orange-900 leading-tight">
                    Restrict Account
                  </p>
      ...
      {(!onlyBan || onlyDelete) && (
        <div className="flex flex-col gap-4 p-4 border border-destructive/10 bg-destructive/5 rounded-xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-sm text-destructive leading-tight">
                Permanent Deletion
              </p>
