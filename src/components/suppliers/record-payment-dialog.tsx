...
export const RecordPaymentDialog = ({ open, onOpenChange, supplierId, supplierName, outstandingBalance, purchaseId, defaultAmount, defaultNotes }: Props) => {
                        ...
                        <>
                            {method !== "cash" && (
                                <form.Field name="reference">
                                    {(field) => (
                                        <Field>
                                            <FieldLabel>{method === "cheque" ? "Cheque Number" : "Transaction ID"}</FieldLabel>
                                            <Input
                                                placeholder={method === "cheque" ? "e.g. 123456" : "e.g. Bank Tx ID"}
                                                value={field.state.value || ""}
                                                onChange={(e) => field.handleChange(e.target.value)}
                                            />
                                            <FieldError errors={field.state.meta.errors} />
