...
export const DeletePurchaseDialog = ({ open, onOpenChange, purchase }: Props) => {
    ...
    const mutate = useMutation({
        ...
        onError: (err) => toast.error(err.message || "Failed to delete purchase record"),
    });
        ...
        >
            <div className="flex flex-col gap-4">
                <div className="flex items-center gap-3 p-4 bg-destructive/10 text-red-700 rounded-lg border">
                    ...
                    <p className="text-sm">
                        This action cannot be undone. This will permanently remove the record of buying <strong>{purchase.quantity}</strong> units.
                    </p>
                </div>
