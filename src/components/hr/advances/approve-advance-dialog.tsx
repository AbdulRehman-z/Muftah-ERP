...
export const ApproveAdvanceDialog = ({ open, onOpenChange, advanceId, amount }: { open: boolean, onOpenChange: (open: boolean) => void, advanceId: string | null, amount: string | null }) => {
        ...
        >
            <div className="space-y-4 py-4">
                <div className="p-4 bg-muted/30 rounded-lg flex items-center justify-between">
                    ...
                    <span className="text-lg font-black text-primary">PKR {amount ? parseFloat(amount).toLocaleString() : "0"}</span>
                </div>
