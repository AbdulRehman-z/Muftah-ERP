...
export const RequestAdvanceDialog = ({ open, onOpenChange }: { open: boolean, onOpenChange: (open: boolean) => void }) => {
        ...
        >
            <div className="space-y-4 py-4">
                <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-700">Employee <span className="text-destructive">*</span></label>
                ...
                <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-700">Amount (PKR) <span className="text-destructive">*</span></label>
                    <Input
                        type="number"
                ...
                <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-700">Reason / Description <span className="text-destructive">*</span></label>
                    <Textarea
                ...
                <div className="flex justify-end gap-3 pt-6 border-t mt-6">
                    ...
                    <Button onClick={handleSubmit} disabled={mutate.isPending}>
                        {mutate.isPending && <Loader2 className="size-4 mr-2 animate-spin" />}
                        Submit Request
                    </Button>
                </div>
            </div>
