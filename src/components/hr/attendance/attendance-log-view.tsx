...
export const AttendanceLogView = () => {
    const { employeeId } = useParams({ from: "/_protected/hr/attendance/$employeeId" });
    const { from, to } = useSearch({ from: "/_protected/hr/attendance/$employeeId" });
    ...
    const isDirty = localFrom !== (from || defaultStart) || localTo !== (to || defaultEnd);
                ...
                <div className="flex flex-wrap items-center gap-4">
                    <div className="flex items-center gap-3 bg-muted/30 px-5 rounded-xl border border-dashed">
                        <div className="flex items-center gap-2 px-3 border-r pr-4">
                            <span className="text-[10px] font-black uppercase text-muted-foreground tracking-tighter">Start</span>
                            <DatePicker
                        ...
                        <div className="flex items-center gap-2 px-3">
                            <span className="text-[10px] font-black uppercase text-muted-foreground tracking-tighter">End</span>
                            <DatePicker
