...
export const EmployeeAttendanceLog = ({
  ...
  const stats = {
    totalDuty: records
      .reduce((acc, r) => acc + (parseFloat(r.dutyHours || "0") || 0), 0)
      .toFixed(1),
    totalOvertime: records
      .reduce((acc, r) => acc + (parseFloat(r.overtimeHours || "0") || 0), 0)
      .toFixed(1),
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5 items-stretch">
            ...
            <div className="relative p-6 flex flex-col sm:flex-row items-center sm:items-start gap-5">
              ...
              <div className="flex-1 text-center sm:text-left space-y-2">
                ...
                <div className="flex items-center justify-center sm:justify-start gap-2 pt-1">
                  <Badge
                    variant="outline"
                    className="bg-emerald-500/10 text-emerald-700 border-emerald-500/20 text-[10px] font-bold tracking-wider"
                  >
                    FULL TIME
                  </Badge>
                </div>
        ...
        <div
          className={`grid grid-cols-2 lg:grid-cols-3 gap-5 ${showHeader ? "md:col-span-6 lg:col-span-7" : "md:col-span-12"}`}
        >
            ...
            <div className="relative space-y-3">
              ...
              <div>
                ...
                <p className="text-3xl font-black text-emerald-700 tracking-tight">
                  {stats.totalDuty}
                  <span className="text-sm font-bold ml-1 opacity-60">hrs</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-2xl border bg-rose-50/30 p-5  transition-all hover: group col-span-2 lg:col-span-1">
            ...
            <div className="relative space-y-3">
              ...
              <div>
                <p className="text-[10px] font-bold uppercase tracking-widest text-rose-600/70">
                  Undertime
                </p>
                ...
                >
                  ...
                  <TableCell className="font-semibold text-xs">
                    <div className="flex flex-col">
                      ...
                      {record?.dutyHours &&
                        parseFloat(record.dutyHours) <
                          (employee.standardDutyHours || 8) &&
                  ...
                  <TableCell>
                    {record ? (
                      ...
                      <Badge
                        variant="outline"
                        className="text-[10px] border-green-500 text-green-500 bg-green-50"
                      >
                        PENDING
                      </Badge>
                    )}
