    ...
    <div className="space-y-6">
            ...
            <div className="text-2xl font-bold">
              {
                employees.filter(
                  (e) =>
                    new Date(e.joiningDate).getMonth() ===
                    new Date().getMonth(),
                ).length
              }
            </div>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              ...
              {employees
                ...
                .reduce(
                  (acc, curr) => acc + parseFloat(curr.standardSalary || "0"),
                  0,
                ) // Roughly 2x basic is total comp based on ratio
                .toLocaleString()}
            </div>
            <p className="text-xs text-muted-foreground mt-1">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage your team, roles, and compensation details.
          </CardDescription>
        </CardHeader>
        <CardContent>
