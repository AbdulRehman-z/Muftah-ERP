...
export const OverrideBradfordDialog = ({ open, onOpenChange, payslipId, currentScore }: Props) => {
        ...
        >
            <div className="space-y-4 py-4">
                <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-700">New Score</label>
                    <Input
                        type="number"
                    ...
                    <p className="text-xs text-muted-foreground">
                        Leaving this blank will remove the override and revert to the system-calculated score.
                    </p>
                </div>
                ...
                <div className="flex justify-end gap-3 pt-4 border-t">
                    ...
                    <Button onClick={handleSave} disabled={mutate.isPending}>
                        {mutate.isPending ? <Loader2 className="size-4 mr-2 animate-spin" /> : null}
                        Save Changes
                    </Button>
                </div>
            </div>
