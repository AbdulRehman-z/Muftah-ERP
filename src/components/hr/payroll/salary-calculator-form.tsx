...
const styles = {
    ...
    totalLbl: { ...base, fontWeight: 700, textAlign: "right" as const, background: "#f3f4f6" } as React.CSSProperties,
    totalNum: { ...base, fontWeight: 700, textAlign: "right" as const, background: "#f3f4f6", fontVariantNumeric: "tabular-nums" } as React.CSSProperties,
    netLbl: { ...base, fontWeight: 800, background: "#ADD8E6", fontSize: 12 } as React.CSSProperties,
    netNum: { ...base, fontWeight: 800, background: "#ADD8E6", fontSize: 12, textAlign: "right" as const, fontVariantNumeric: "tabular-nums" } as React.CSSProperties,
};
