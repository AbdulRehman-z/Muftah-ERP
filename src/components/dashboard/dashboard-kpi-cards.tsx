    ...
    return (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <KpiCard
                ...
                trendLabel={profitPositive || profitNegative ? `${profitMargin}% margin` : "Break-even"}
...
> = {
    emerald: {
        ...
        badge: "bg-emerald-50 border-emerald-200 dark:bg-emerald-950/40 dark:border-emerald-800",
        badgeText: "text-emerald-700 dark:text-emerald-400",
    },
    rose: {
        icon: "text-rose-600 dark:text-rose-400",
        iconBg: "bg-rose-50 dark:bg-rose-950/40",
        badge: "bg-rose-50 border-rose-200 dark:bg-rose-950/40 dark:border-rose-800",
        badgeText: "text-rose-700 dark:text-rose-400",
    },
    amber: {
        icon: "text-amber-600 dark:text-amber-400",
        iconBg: "bg-amber-50 dark:bg-amber-950/40",
        badge: "bg-amber-50 border-amber-200 dark:bg-amber-950/40 dark:border-amber-800",
    ...
    violet: {
        ...
        badge: "bg-violet-50 border-violet-200 dark:bg-violet-950/40 dark:border-violet-800",
