...
import { RefreshCw, CalendarDays, TrendingUp, TrendingDown, HardDrive } from "lucide-react";
...
export function AdminDashboard() {
    ...
    const startDate = dateRange.from?.toISOString() ?? startOfMonth(today).toISOString();
    const endDate = dateRange.to?.toISOString() ?? endOfMonth(today).toISOString();
    ...
    const displayRange = dateRange.to && dateRange.from
