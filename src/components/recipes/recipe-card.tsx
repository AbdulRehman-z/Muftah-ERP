    ...
    <>
      <Card className="hover: transition-shadow flex flex-col justify-between h-full group">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <div>
                ...
                <p className="font-medium">
                  {recipe.containersPerCarton || "Loose"}
                </p>
              </div>
              <div>
              ...
              <div className="pt-2 border-t">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-green-600">
                    PKR{" "}
                    {parseFloat(recipe.estimatedCostPerContainer).toFixed(2)}
                  </span>
                </div>
        ...
        <div className="p-4 pt-0 space-y-3">
          <Button onClick={() => setInitiateOpen(true)} className="w-full">
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              recipe <strong>{recipe.name}</strong> and remove it from the
              database. Associated production history will remain but the recipe
