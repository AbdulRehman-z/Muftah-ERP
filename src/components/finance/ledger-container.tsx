      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-muted-foreground tabular-nums uppercase tracking-widest font-semibold">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
              ...
              <Select value={sourceFilter} onValueChange={handleSourceFilter}>
                ...
                <SelectContent className="rounded-none shadow-none border-border">
                  ...
                  <SelectItem value="Sale" className="rounded-none">
                    Sale
                  </SelectItem>
                  <SelectItem value="Payroll" className="rounded-none">
                    Payroll
                  </SelectItem>
                  <SelectItem value="Expense" className="rounded-none">
                    Expense
                  </SelectItem>
                  <SelectItem value="Opening Balance" className="rounded-none">
                    Opening Balance
                  </SelectItem>
                  <SelectItem
