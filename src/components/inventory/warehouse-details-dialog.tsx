...
export const WarehouseDetailsDialog = ({ open, onOpenChange, warehouse }: Props) => {
                ...
                <div className="bg-primary/5 p-6 border-b border-primary/10">
                    <DialogHeader className="space-y-1">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <Badge variant={warehouse.isActive ? "healthy" : "secondary"} className="text-[10px] font-bold uppercase tracking-widest">
                        ...
                        <DialogDescription className="text-muted-foreground flex items-center gap-2 pt-1">
                            ...
                            <span className="font-medium text-foreground">{warehouse.city}, {warehouse.state}</span>
                            <span className="text-[10px] opacity-50 font-mono">ID: {warehouse.id}</span>
                        </DialogDescription>
                    </DialogHeader>
                </div>
                            ...
                            <div className="p-4 rounded-2xl border bg-muted/5 flex flex-col gap-3">
                                ...
                                <div className="space-y-1">
                                    <div className="flex justify-between items-center text-xs">
                                        ...
                                        <span className="font-mono font-bold">{warehouse.latitude}</span>
                                    </div>
                                    <div className="flex justify-between items-center text-xs">
                                        <span className="text-muted-foreground">Longitude</span>
                                        <span className="font-mono font-bold">{warehouse.longitude}</span>
                                    </div>
                                </div>
                            </div>
                            <div className="p-4 rounded-2xl border bg-muted/5 flex flex-col gap-3">
                                ...
                                <div className="flex flex-col">
                                    <span className="text-sm font-bold capitalize">{warehouse.type.replace("_", " ")}</span>
                                    <span className="text-[10px] text-muted-foreground">Industrial Category</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-4 rounded-xl border border-dashed bg-primary/5 flex flex-col gap-1">
                                    <div className="flex items-center gap-2 text-muted-foreground mb-1">
                                        ...
                                        <span className="text-[10px] font-bold uppercase tracking-tighter">Facility Registered</span>
                                    </div>
                                    <p className="font-bold text-sm text-foreground">{format(createdAt, "PPP")}</p>
                                    <p className="text-[10px] font-mono text-muted-foreground opacity-70">{format(createdAt, "pp")}</p>
                                </div>
                                <div className="p-4 rounded-xl border border-dashed bg-primary/5 flex flex-col gap-1">
                                    <div className="flex items-center gap-2 text-muted-foreground mb-1">
                                        <Clock className="size-3.5" />
                                        <span className="text-[10px] font-bold uppercase tracking-tighter">Record Last Modified</span>
                                    </div>
                                    <p className="font-bold text-sm text-foreground">{format(updatedAt, "PPP")}</p>
                                    <p className="text-[10px] font-mono text-muted-foreground opacity-70">{format(updatedAt, "pp")}</p>
                                </div>
                            </div>
                        </div>
